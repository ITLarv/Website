...
export default function Contact() {
	...
	// prettier-ignore
	const pgList = [
		{id:"2", name:"Erik Boson", role:t("ROLES.PG.VPL"), email:"viceprojektledare@larv.org", imgSrc:vakant},
		{id:"3", name:"Fabian Kroner", role:t("ROLES.PG.FTG"), email:"anmalan@larv.org", imgSrc:vakant},
		{id:"4", name:"Vakant", role:t("ROLES.PG.FTG"), email:"anmalan@larv.org", imgSrc:vakant},
		{id:"5", name:"Karlo Ravlic", role:t("ROLES.PG.EVENT"), email:"event@larv.org", imgSrc:vakant},
		{id:"6", name:"Vakant", role:t("ROLES.PG.SAMARBETE"), email:"samarbete@larv.org", imgSrc:vakant},
		{id:"7", name:"Hanna Wall", role:t("ROLES.PG.GRAFIK"), email:"grafiker@larv.org", imgSrc:vakant},
		{id:"8", name:"Leo Hemmingsson", role:t("ROLES.PG.IT"), email:"it@larv.org", imgSrc:vakant},
		...
		{id:"12", name:"Marcus Garplid", role:t("ROLES.PG.REKRYTERING"), email:"rekrytering@larv.org", imgSrc:vakant},
